...
const Create = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      imageUrl_4: null,
      imageUrl_5: null,
      videoUrl: null, // Added missing field
    },
  });
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 p-6">
      <Header
        ...
        description="Add new destination here. Click save when you're done."
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-6 border-t">
          <LoadingBtn isSubmitting={isSubmitting} title="Save Destination" />
        </div>
      </form>
    </div>
  );
