...
import { accommodationTypes, transportationTypes } from ".";
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-900/95 to-teal-800/95 backdrop-blur-lg z-30 md:hidden animate-in fade-in duration-300">
      <div className="flex flex-col h-full">
        {/* Mobile Menu Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/20 animate-in slide-in-from-top duration-500 mb-3">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 space-y-6">
          ...
          <Link
            to={"/accommodations"}
            className="space-y-3 animate-in slide-in-from-left duration-700 delay-200"
            onClick={toggleMenu}
          >
            <div className="w-full flex items-center space-x-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 hover:bg-white/20 transition-all duration-300 group hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20">
